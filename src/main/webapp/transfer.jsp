...
%>
	...
	<div class="sidenav">
         <div class="login-main-text">
            <h3>Transfer to an external account</h3>
      ...
      <div class="main">
         <div class="col-md-6 col-sm-12">
            <div class="login-form2">
               <form class="well form-horizontal" action="<%=request.getContextPath()%>/Transfer"
						method="post" id="transfer">
						
						
						<div class="form-group">
							<h5>Your Account ID: ${accountId}</h5>			
						</div> 
						
						
						<div class="form-group">
							<label class="control-label">Account ID to transfer to</label> 
							<input type="text" class="form-control"
								name="transferAccountId" placeholder="Account ID">
						</div>
                		...
                		<div class="form-group">
							...
							<input type="text" class="form-control"
								name="transferAmount" placeholder="Transfer amount in USD">
						</div>
